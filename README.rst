 ...
 * ``gcc``, ``binutils``, ``make``, and other libraries and standard development tools (required by CouchDB native code);
...
Just like a normal CouchDB, but listening on http://127.0.0.1:27742/ endpoint.

See https://couchdb.apache.org/ for details.
